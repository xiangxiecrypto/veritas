...
exports.PrimusAttestationVerifier = void 0;
const ethers_1 = require("ethers");
/**
 * Extract data from Primus attestation result
 * Handles different response formats
 */
function extractAttestationData(attestationResult) {
 ...
 * ```
 */
class PrimusAttestationVerifier {
    constructor(provider) {
        this.knownAttestors = new Set();
        this.lastAttestorUpdate = 0;
        this.ATTESTOR_CACHE_TTL = 5 * 60 * 1000; // 5 minutes
     ...
     */
    async verify(attestationResult, config = {}) {
        const errors = [];
        const warnings = [];
        const { maxAgeMs = 24 * 60 * 60 * 1000, // Default: 24 hours
        expectedApiUrl, requiredDataKeys = [], allowedAttestors } = config;
     ...
     */
    async isValid(attestationResult, config = {}) {
        const result = await this.verify(attestationResult, config);
        return result.valid;
    }
}
exports.PrimusAttestationVerifier = PrimusAttestationVerifier;
exports.default = PrimusAttestationVerifier;
//# sourceMappingURL=PrimusAttestationVerifier.js.map