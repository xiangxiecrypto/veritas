/**
 * COMPLETE WORKING SOLUTION: Direct TaskContract Calls
 * 
 * This bypasses the PrimusNetwork SDK bug by calling TaskContract directly.
 * The callbackAddress is correctly passed and the auto-callback works!
 */
...
async function main() {
  console.log('\n╔═══════════════════════════════════════════════════════════════════════════╗');
  console.log('║  COMPLETE WORKING SOLUTION: Direct TaskContract Calls        ║');
  ...
  // Add rule: BTC price check ($60k-$100k)
  ...
  // ==========================================================================
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('STEP 2: CALL TASKCONTRACT DIRECTLY (BYPASS SDK BUG)');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');

  // Create TaskContract instance directly
  ...
  console.log('  templateId: "" (empty - URL is in attest later)');
  console.log('  attestorCount: 1');
  console.log('  tokenSymbol: 0 (ETH)');
  console.log('  callback:', appV5.address, '← THIS WILL WORK!');
  console.log('');
  ...
  const tx = await taskContract.submitTask(
    ...
    appV5.address,      // 5. callback ← SET TO OUR CONTRACT!
    { value: totalFee } // Transaction value
  );
  ...
  if (task.callback === appV5.address) {
    ...
    console.log('║                                                                           ║');
    console.log('║  TaskContract.submitTask() works perfectly when called directly!║');
    console.log('╚═══════════════════════════════════════════════════════════════════════════╝\n');
  } else {
  ...
  // ==========================================================================
  // STEP 3: Use Primus SDK for Attestation (This part works!)
  // ==========================================================================
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  // SDK attest works fine - just need the taskId we created
  ...
  console.log('  - PrimusNetwork SDK has a bug (doesnt forward callbackAddress)');
