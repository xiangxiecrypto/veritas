...
async function main() {
  ...
  console.log("Deploying VeritasValidationRegistryV3...");
  console.log("Deployer:", deployer.address);
  
  const VeritasV3 = await hre.ethers.getContractFactory("VeritasValidationRegistryV3");
  ...
  // Primus attestation contract on Base Sepolia
  const primusTaskContract = "0xC02234058caEaA9416506eABf6Ef3122fCA939E8"; // Primus Task Contract on Base Sepolia
