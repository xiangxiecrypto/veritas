...
async function main() {
  ...
  console.log("🔑 Authorizing validator on VeritasValidationRegistry v3");
  console.log("Owner:", deployer.address);
  
  // Validation Registry v3 address (already deployed)
  const VALIDATION_REGISTRY_ADDRESS = "0x0C07f1D3c46fA6fCcB94ecfC26C6C2d33710f70E";
  
  // Wallet to authorize (the deployer)
